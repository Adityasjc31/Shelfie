...
/**
 * AOP Aspect for centralized logging across the Review service.
 * 
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.book.management.review_rating.controller..*)")
    public void controllerLayer() {}

    /**
     * Pointcut for all service methods.
     */
    @Pointcut("within(com.book.management.review_rating.service..*)")
    public void serviceLayer() {}

    /**
     * Pointcut for all repository methods.
     */
    @Pointcut("within(com.book.management.review_rating.repository..*)")

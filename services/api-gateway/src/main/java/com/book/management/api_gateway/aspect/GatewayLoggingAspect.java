...
public class GatewayLoggingAspect {
     ...
     */
    @Pointcut("execution(* com.book.management.api_gateway.filter..*(..))")
     ...
     */
    @Pointcut("execution(* com.book.management.api_gateway.controller..*(..))")
     ...
     */
    @Pointcut("execution(* com.book.management.api_gateway.config..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "filterLayer() || controllerLayer() || configLayer()", throwing = "exception")
     ...
     */
    @Pointcut("@annotation(com.book.management.api_gateway.annotation.LogExecutionTime)")
